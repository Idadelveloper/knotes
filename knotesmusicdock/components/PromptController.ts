...
// FIX: Added import for Prompt and ControlChange types. The error was that these types were not exported from ../types.
import type { Prompt, ControlChange } from '../types';

/** A single prompt input associated with a MIDI CC. */
@customElement('prompt-controller')
export class PromptController extends LitElement {
  // FIX: Removed override keyword to fix build error.
  static styles = css`
    .prompt {
      width: 100%;
      display: flex;
